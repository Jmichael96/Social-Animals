...
import { MDBCarousel, MDBCarouselCaption, MDBCarouselInner, MDBCarouselItem, MDBView, MDBMask, MDBRow, MDBCol, MDBContainer } from
    "mdbreact";
import "./style.css";
const CarouselPage = () => {
    return (
                    ...
                    <MDBCarousel id="object" activeItem={1} length={4} showControls={true} showIndicators={true} className="z-depth-5">
                        <MDBCarouselInner>
                            ...
                            <MDBCarouselItem itemId="3">
                                <img id="img" className="d-block w-100" src="/assets/images/img7.jpg" alt="Second slide" />
                            </MDBCarouselItem>
